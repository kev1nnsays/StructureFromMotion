function[epipolar_eq] = graphEpipolarLines(priors, epipolar_eq, numOfPtsPerLine)
...
for i = 1: length(epipolarLine_graphpoints(:,1))
    ...
    for j = 1:numOfPtsPerLine-1
        ...
        %plot orignal x'
        plot(priors(1, i), priors(2, i), 'Color', color, 'Marker', '.', 'MarkerSize', 10);%original correspondences 
